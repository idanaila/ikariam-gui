...
my_tree['columns'] = ("Oid", "City", "Town Hall", "Academy", "Warehouse", "Tavern", "Palace", "G Residence", "Museum", "Trading Port", "Shipyard", "Barracks", "Town Wall", "Embassy", "Trading Post", "Workshop", "Hideout", "Forester", "Glassblower", "Alchemist", "Winery", "Stonemason", "Carpenter", "Optician", "Firework", "Wine Press", "Architect", "Temple", "Depot", "Pirate Fortress", "Black Market", "Sea Chart")

# format our columns

my_tree.column("#0", width=0, stretch=NO)
my_tree.column("Oid", anchor=CENTER, width=100)
my_tree.column("Town Hall", anchor=CENTER, width=100)
my_tree.column("Academy", anchor=CENTER, width=100)
my_tree.column("Warehouse", anchor=CENTER, width=100)
my_tree.column("Tavern", anchor=CENTER, width=100)
my_tree.column("Palace", anchor=CENTER, width=100)
my_tree.column("G Residence", anchor=CENTER, width=100)
my_tree.column("Museum", anchor=CENTER, width=100)
my_tree.column("Trading Port", anchor=CENTER, width=100)
my_tree.column("Shipyard", anchor=CENTER, width=100)
my_tree.column("Barracks", anchor=CENTER, width=100)
my_tree.column("Town Wall", anchor=CENTER, width=100)
my_tree.column("Embassy", anchor=CENTER, width=100)
my_tree.column("Trading Post", anchor=CENTER, width=100)
my_tree.column("Workshop", anchor=CENTER, width=100)
my_tree.column("Hideout", anchor=CENTER, width=100)
my_tree.column("Forester", anchor=CENTER, width=100)
my_tree.column("Glassblower", anchor=CENTER, width=100)
my_tree.column("Alchemist", anchor=CENTER, width=100)
my_tree.column("Winery", anchor=CENTER, width=100)
my_tree.column("Stonemason", anchor=CENTER, width=100)
my_tree.column("Carpenter", anchor=CENTER, width=100)
my_tree.column("Optician", anchor=CENTER, width=100)
my_tree.column("Firework", anchor=CENTER, width=100)
my_tree.column("Wine Press", anchor=CENTER, width=100)
my_tree.column("Architect", anchor=CENTER, width=100)
my_tree.column("Temple", anchor=CENTER, width=100)
my_tree.column("Depot", anchor=CENTER, width=100)
my_tree.column("Pirate Fortress", anchor=CENTER, width=100)
my_tree.column("Black Market", anchor=CENTER, width=100)
my_tree.column("Sea Chart", anchor=CENTER, width=100)

# create teh headings

my_tree.heading("Oid", text="Oid", anchor=W)
my_tree.heading("City", text="City", anchor=W)
my_tree.heading("Town Hall", text="Town Hall", anchor=CENTER)
my_tree.heading("Academy", text="Academy", anchor=CENTER)
my_tree.heading("Warehouse", text="Warehouse", anchor=CENTER)
my_tree.heading("Tavern", text="Tavern", anchor=CENTER)
my_tree.heading("Palace", text="Palace", anchor=CENTER)
my_tree.heading("G Residence", text="G Residence", anchor=CENTER)
my_tree.heading("Museum", text="Museum", anchor=CENTER)
my_tree.heading("Trading Port", text="Trading Port", anchor=CENTER)
my_tree.heading("Shipyard", text="Shipyard", anchor=CENTER)
my_tree.heading("Barracks", text="Barracks", anchor=CENTER)
my_tree.heading("Town Wall", text="Town Wall", anchor=CENTER)
my_tree.heading("Embassy", text="Embassy", anchor=CENTER)
my_tree.heading("Trading Post", text="Trading Post", anchor=CENTER)
my_tree.heading("Workshop", text="Workshop", anchor=CENTER)
my_tree.heading("Hideout", text="Hideout", anchor=CENTER)
my_tree.heading("Forester", text="Forester", anchor=CENTER)
my_tree.heading("Glassblower", text="Glassblower", anchor=CENTER)
my_tree.heading("Alchemist", text="Alchemist", anchor=CENTER)
my_tree.heading("Winery", text="Winery", anchor=CENTER) 
my_tree.heading("Stonemason", text="Stonemason", anchor=CENTER)
my_tree.heading("Carpenter", text="Carpenter", anchor=CENTER)
my_tree.heading("Optician", text="Optician", anchor=CENTER)
my_tree.heading("Firework", text="Firework", anchor=CENTER)
my_tree.heading("Wine Press", text="Wine Press", anchor=CENTER)
my_tree.heading("Architect", text="Architect", anchor=CENTER)
my_tree.heading("Temple", text="Temple", anchor=CENTER)
my_tree.heading("Depot", text="Depot", anchor=CENTER)
my_tree.heading("Pirate Fortress", text="Pirate", anchor=CENTER)
my_tree.heading("Black Market", text="Black Market", anchor=CENTER) 
my_tree.heading("Sea Chart", text="Sea Chart", anchor=CENTER)
